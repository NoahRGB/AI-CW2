...
if __name__ == "__main__":
    ...
    # plt.title("Bar chart showing the Mean Average Error (MAE) of 3 regressors using the train dataset")
    ...
    plt.figure(figsize=(20, 20))
    plt.title("Comparing the predictions of 3 different regressors on the 'current_delay' feature from the training data")
    plt.scatter(X["current_delay"], y, color="black", label="Training data", s=5)
