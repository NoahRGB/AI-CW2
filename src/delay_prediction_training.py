...
norwich_to_london_stops = ["NRW", "DIS", "SMK", "IPS", "MNG", "COL", "CHM", "SRA", "LST"]
london_to_norwich_stops = ["LST", "SRA", "CHM", "COL", "MNG", "IPS", "SMK", "DIS", "NRW"]
...
X = X_encoded # overwrite the old dataframe with the new encoded one
